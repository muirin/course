...
class Teacher extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('id, name, surname, photos', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'subjectRatings' => array(self::HAS_MANY, 'SubjectRating', 'teacher_id'),
			'teacherRatings' => array(self::HAS_MANY, 'TeacherRating', 'teacher_id'),
			'teacherSubjects' => array(self::HAS_MANY, 'TeacherSubject', 'teacher_id'),
		);
	}
